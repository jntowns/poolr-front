<template>
    <div class="provider-section">
        ...
        <div v-if="!isAuthenticated" class="auth-required-message">
            <p>You must be signed in to complete payment and book this ride.</p>
            <button class="login-btn" @click="$emit('login')">Sign In to Continue</button>
        </div>
            ...
            <div class="paypal-panel">
                ...
                <div v-if="paypalAvailable">
                    ...
                    <div v-if="paypalError" class="paypal-status error">
                        {{ paypalError }}
                        <button v-if="paypalStatus === 'error'" type="button" class="retry-btn" @click="handleRetry">
                            Retry
                        </button>
                    </div>
                </div>
