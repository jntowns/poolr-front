      ...
      <form @submit.prevent="submitForm" class="space-y-6">
        ...
        <div>
          ...
          <div class="mt-2">
            ...
            >
              <option value="App Bug" class="bg-gray-800 text-white">App Bug</option>
              <option value="Payment Issue" class="bg-gray-800 text-white">Payment Issue</option>
              <option value="Account Issue" class="bg-gray-800 text-white">Account Issue</option>
              <option value="Driver/Rider Issue" class="bg-gray-800 text-white">Driver/Rider Issue</option>
              <option value="Incomplete Ride" class="bg-gray-800 text-white">Incomplete Ride</option>
