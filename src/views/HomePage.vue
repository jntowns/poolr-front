        ...
        <div class="max-w-7xl mx-auto px-6 pt-12 lg:pt-24 pb-20">
            <div class="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                <div class="space-y-8">
                    ...
                    <h1 class="text-5xl lg:text-7xl font-bold tracking-tight leading-tight text-slate-900">
                        The modern way <br />
                        <span class="text-transparent bg-clip-text bg-gradient-to-r from-electric-blue to-soft-teal">to
                            carpool.</span>
                    </h1>

                    <p class="text-lg lg:text-xl text-slate-500 max-w-lg leading-relaxed">
                        Poolr connects you with neighbors for seamless ridesharing. Save costs, reduce traffic, and meet
                        great people.
                    </p>
                    ...
                    <div class="pt-8 border-t border-slate-100 mt-8">
                        <div class="flex items-baseline gap-3">
                            ...
                            <span class="text-slate-500 font-medium">active rides happening right now</span>
                        </div>
                    </div>
                </div>
