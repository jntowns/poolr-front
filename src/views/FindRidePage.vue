<template>
    <<<<<<< Way-POIs-frontend <div class="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="max-w-2xl mx-auto">
                        <div class="bg-white rounded-xl shadow-lg p-8">
                            ...
                            <div class="mb-6">
                                ...
                                <div class="flex gap-2">
                                    <div class="flex-1">
                                        <AddressSearchBar v-model="origin" placeholder="Enter pickup location..."
                                            :min-chars="2" :debounce-delay="300" :max-results="10"
                                            @select="handleOriginSelect" @clear="handleOriginClear" />
                                        >>>>>>> main
                                    </div>
                                    <button @click="getUserLocation" :disabled="isGettingLocation"
                                        class="px-4 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:bg-gray-400 disabled:cursor-not-allowed transition duration-200 flex items-center gap-2"
                            ...
                            <div class="mb-6">
                                ...
                                <AddressSearchBar v-model="destination" placeholder="Enter destination..."
                                    :min-chars="2" :debounce-delay="300" :max-results="10"
                                    @select="handleDestinationSelect" @clear="handleDestinationClear" />
                            </div>
